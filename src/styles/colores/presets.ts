...
export type ColorPresetId = "verde-oscuro-premium";
...
export const colorPresets: Record<ColorPresetId, ColorPreset> = {
  "verde-oscuro-premium": {
    id: "verde-oscuro-premium",
    name: "Verde Oscuro Premium",
    tokens: {
      primary: "153 44% 30%",
